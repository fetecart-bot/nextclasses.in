...
import { Search, Sparkles, Star, Users, CheckCircle2, BookOpen, Clock, Globe, ArrowRight, ShieldCheck, Languages, Settings, Play } from 'lucide-react';
                    ...
                    <div className="pt-4 flex items-center justify-between gap-3">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 px-3 py-2 rounded-lg bg-neutral-800 text-neutral-200 text-xs font-semibold hover:bg-neutral-700 hover:text-white transition-colors cursor-pointer"
                        ...
                        <button
                          ...
                          className="px-3.5 py-2 rounded-lg bg-gradient-to-r from-orange-500 to-amber-500 text-neutral-950 font-bold text-xs hover:opacity-90 transition-all shadow-sm cursor-pointer"
                        >
                          {t('enrollNow', 'Enroll')}
                        </button>
                      </div>
