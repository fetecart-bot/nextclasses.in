...
export const COURSE_VIDEO_PLAYLISTS: Record<string, PortalVideoLesson[]> = {
  ...
  'course-english-speaking': [
    {
      id: 'eng-vid-1',
      title: '01. Spoken English Fluency & Confident Pronunciation - BBC Masterclass',
      duration: '18:45',
    ...
    {
      id: 'eng-vid-2',
      title: '02. Thinking in English: Overcoming Mother-Tongue Translation Barriers',
      duration: '16:30',
      company: 'NextClass Language Wing',
      youtubeId: 'eIho2S0ZahI',
      youtubeUrl: 'https://www.youtube.com/watch?v=eIho2S0ZahI',
      description: 'Practical cognitive habits to eliminate inner translation, build immediate word recall, and formulate complex thoughts naturally.',
      badge: 'Cadence & Fluency',
    },
    {
      id: 'eng-vid-3',
      title: '03. Professional Workplace Dialogues, Presentations & Salary Negotiations',
      duration: '21:10',
      company: 'NextClass Business Communication',
      youtubeId: 'Wn_eS5dcVyc',
      youtubeUrl: 'https://www.youtube.com/watch?v=Wn_eS5dcVyc',
      description: 'High-impact vocabulary, assertive diplomatic phrasing, meeting facilitation, and answering tough interview questions with poise.',
      badge: 'Corporate English',
    },
  ],
  ...
  'course-french-speaking': [
    {
      id: 'fr-vid-1',
      title: '01. Learn French Spoken Fluency: Natural French Dialogues & Pronunciation',
      duration: '19:15',
    ...
    {
      id: 'fr-vid-2',
      title: '02. French Phonetics: Mastering Nasal Vowels, R-Sound & Liaisons',
      duration: '17:40',
      company: 'NextClass European Languages',
      youtubeId: '4-rWPEqXy-M',
      youtubeUrl: 'https://www.youtube.com/watch?v=4-rWPEqXy-M',
      description: 'Step-by-step vocal mouth positioning to master challenging French sounds and speak like a native Parisian.',
      badge: 'Phonetics & Accent',
    },
  ],
  ...
  'course-german-speaking': [
    {
      id: 'de-vid-1',
      title: '01. Nicos Weg: Complete Conversational German Course A1–B2',
      duration: '22:30',
    ...
    {
      id: 'de-vid-2',
      title: '02. German Sentence Structure (TeKaMoLo) & Case Endings Masterclass',
      duration: '18:50',
      company: 'NextClass German Academy',
      youtubeId: 'ujDtm0hZyII',
      youtubeUrl: 'https://www.youtube.com/watch?v=ujDtm0hZyII',
      description: 'Demystify German word order in subordinate clauses, adjective declensions, and everyday professional office dialogues.',
  ...
  'course-public-speaking-articulation': [
    ...
    {
      id: 'speak-vid-2',
      title: '02. Overcoming Stage Fright & Imposter Syndrome on Camera or Podium',
      duration: '16:20',
      company: 'NextClass Leadership Lab',
      youtubeId: 'r5z_V-tLz4A',
      youtubeUrl: 'https://www.youtube.com/watch?v=r5z_V-tLz4A',
  ...
  'course-neet-ug': [
    {
      id: 'neet-vid-1',
      title: '01. NEET 2027: Biology 360/360 High-Yield NCERT Decoding & Speed Solving',
      duration: '24:10',
    ...
    {
      id: 'neet-vid-2',
      title: '02. NEET Physics: Mechanics, Optics & Electrostatics Shortcut Formulas',
      duration: '22:30',
      company: 'NextClass Physics Lab',
      youtubeId: 'r5z_V-tLz4A',
      youtubeUrl: 'https://www.youtube.com/watch?v=r5z_V-tLz4A',
      description: 'Dimensional analysis shortcuts, friction and pulley speed tricks, and 30-second circuit calculations without lengthy algebraic derivations.',
      badge: 'Physics Shortcuts',
    },
    {
      id: 'neet-vid-3',
      title: '03. NEET Chemistry: Organic Reaction Mechanisms & Physical Mole Shortcuts',
      duration: '20:15',
      company: 'NextClass Chemistry Wing',
      youtubeId: 'WFM2pvj00oc',
      youtubeUrl: 'https://www.youtube.com/watch?v=WFM2pvj00oc',
      description: 'Electrophilic aromatic substitution, name reactions cheat sheet, chemical equilibrium tips, and coordination compound isomerism.',
      badge: 'Chemistry 170+ Target',
    },
  ],
  ...
  'course-iit-jee': [
    {
      id: 'jee-vid-1',
      title: '01. IIT JEE 2027: Rotational Mechanics & Multi-Concept Calculus Sprint',
      duration: '25:30',
      company: 'NextClass JEE Advanced Wing (Official)',
      youtubeId: 'r5z_V-tLz4A',
      youtubeUrl: 'https://www.youtube.com/watch?v=r5z_V-tLz4A',
      description: 'Tackle JEE Advanced multi-concept questions: Moment of inertia matrices, rolling without slipping on moving inclines, and definite integral bounds.',
      badge: 'JEE Advanced Sprint',
    },
    {
      id: 'jee-vid-2',
      title: '02. Coordinate Geometry & Complex Numbers Geometry Shortcuts',
      duration: '23:45',
      company: 'NextClass Mathematics Lab',
      youtubeId: 'mG9R0vjZqj0',
      youtubeUrl: 'https://www.youtube.com/watch?v=mG9R0vjZqj0',
      description: 'Locus of conic sections, parametric coordinates speed solutions, and De Moivre roots geometry for top 99.9 percentile percentile ranking.',
      badge: 'Math 99.9 Percentile',
    },
  ],
  ...
  'course-keam-prep': [
    {
      id: 'keam-vid-1',
      title: '01. KEAM 2027: 120 Questions Speed Solving & 3D Vectors Shortcut',
      duration: '22:15',
      company: 'NextClass Kerala Engineering (Official)',
      youtubeId: 'mG9R0vjZqj0',
      youtubeUrl: 'https://www.youtube.com/watch?v=mG9R0vjZqj0',
      description: 'Kerala Engineering Architecture Medical entrance strategy: 150-minute exam pacing, negative mark prevention, and 3D vectors shortcuts.',
      badge: 'KEAM State Rank',
    },
  ],
  ...
  'course-aissee-sainik-9': [
    {
      id: 'sainik9-vid-1',
      title: '01. Class 9 Advanced Mathematics: Algebraic Expressions & Coordinate Geometry',
      duration: '28:10',
    ...
    {
      id: 'sainik9-vid-2',
      title: '02. Class 9 General Science: Motion, Gravitation & Cell Biology',
      duration: '22:45',
    ...
    {
      id: 'sainik9-vid-3',
      title: '03. Class 9 Social Studies: Indian Freedom Struggle & Constitutional Framework',
      duration: '19:20',
      company: 'NextClass Social Studies',
      youtubeId: 'eIho2S0ZahI',
      youtubeUrl: 'https://www.youtube.com/watch?v=eIho2S0ZahI',
